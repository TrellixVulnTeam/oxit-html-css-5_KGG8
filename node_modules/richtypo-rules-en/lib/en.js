...
exports.default = exports.numberSeparators = exports.numberOrdinals = exports.quotes = exports.dashes = exports.dashesAdvanced = exports.prepositions = exports.definitions = void 0;
...
const definitions = _objectSpread(_objectSpread({}, _richtypoRulesCommon.definitions), {}, {
  thousandsSeparator,
  decimalsSeparator,
  ordinal,
  preposition,
...
.replace(new RegExp(`([^\\s\\]\\)\\>]+)${space}?${emdash}${space}?`, 'gmi'), `<nobr>$1${hairspace}${emdash}</nobr>${hairspace}`) // Add hair spaces before and after an em dash
.replace(new RegExp(`${space}${emdash}${space}`, 'gmi'), `${hairspace}${emdash}${hairspace}`);
